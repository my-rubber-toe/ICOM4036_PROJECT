...
if __name__ == '__main__':
    ...
    # env_ctrl.create_client("myclient")
    # env_ctrl.send_message("myclient","server1", "messageme")
    # env_ctrl.var_assign("external", "http://www.google.com")
    # env_ctrl.info("new_var")
    # env_ctrl.info("myclient")
    # env_ctrl.connect_external("server2","http://www.google.com")
    # env_ctrl.create_server("server1","localhost",0)
